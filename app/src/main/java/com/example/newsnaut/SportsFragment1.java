...
public class SportsFragment1 extends Fragment {

    String api="99120de0188446c0850bb52ce4257f54";
    ArrayList<ModelClass1> modelClassArrayList1;
    Adapter1 adapter1;
    String country="uk";
    private RecyclerView recyclerViewofsports1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sportsfragment1,null);
        recyclerViewofsports1=view.findViewById(R.id.recyclerviewofsports1);
        modelClassArrayList1=new ArrayList<>();
        recyclerViewofsports1.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter1=new Adapter1(getContext(),modelClassArrayList1);
        recyclerViewofsports1.setAdapter(adapter1);
        findNews1();
        return view;
    }
